...
public class PlaceOrderAspect {
    ...
    @Pointcut("execution(* com.p2pdinner.service.DinnerCartDataService.placeOrder(java.lang.Integer, java.lang.Integer, com.p2pdinner.domain.OrderStatus)) && args(profileId, cartId, status)")
    public void placeOrder(java.lang.Integer profileId, java.lang.Integer cartId, com.p2pdinner.domain.OrderStatus status) {
    }

    @Before("placeOrder(profileId,cartId,status)")
    @Transactional
    public void chargeCustomer(java.lang.Integer profileId, java.lang.Integer cartId, com.p2pdinner.domain.OrderStatus status) throws Exception {
        LOGGER.info("-----BEFORE------");
    ...
    @Transactional
    public void updateAvailability(java.lang.Integer profileId, java.lang.Integer cartId, com.p2pdinner.domain.OrderStatus status) throws Exception {
        LOGGER.info("-----AFTER------");
    ...
    @Transactional
    public void refundCustomer(java.lang.Integer profileId, java.lang.Integer cartId, com.p2pdinner.domain.OrderStatus status) throws Exception {
